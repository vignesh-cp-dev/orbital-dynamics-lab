...
export function ContextPanel({ params, solution, selected, status }: ContextPanelProps) {
  if (!selected) {
    return (
      <div className="scroll-thin h-full overflow-y-auto px-4 py-4">
        ...
        <div className="mt-5 border border-border bg-card/40 p-3">
  ...
  return (
    <div key={selected} className="scroll-thin h-full animate-in fade-in slide-in-from-right-2 overflow-y-auto px-4 py-4 duration-300">
